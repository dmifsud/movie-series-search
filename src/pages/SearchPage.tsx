    ...
    return (
        <div className="flex fixed w-full h-full flex-col">
            <nav className="p-4 bg-primary text-white">
                <SearchMovie
                    search={params['s']}
                    type={params['type'] as MovieType}
                />
                <Link
                    to="/watchlist"
                    className="mt-20 bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-600 transition duration-300"
                >
                    Watchlist
                </Link>
            </nav>
